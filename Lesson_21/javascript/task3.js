...
class Client {
    ...
    clientName;
    clientMoney;
    constructor(idClient, clientName, clientMoney) {
...
class GoldenClient extends Client {
    ...
    percentageOfCredit;
    usedLimit = 0;
    constructor(idClient, clientName, clientMoney, creditLimit, percentageOfCredit) {
    ...
    removeMoney(newMoney) {
        ...
        if (newMoney <= this.clientMoney) {
            ...
            if (this.creditLimit > difference) {
                ...
                throw new Error(`Ваш ліміт не дозволяє зняти кошти більше за ваш ліміт ${this.creditLimit}`);
            }
        }
    }
    interestOfCredit() {
