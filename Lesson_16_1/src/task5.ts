...
*/
class TMoney {
  #exchangeRate: number = 45;
  #sumDollars: number = 0;
  #prevSum$:number=0
  constructor(exchangeRate: number = 45, sumDollars: number = 0) {
  ...
  determinationRate(money: number) {
...
const moneyToAdd: number = 500;
const moneyRemove: number = 120;
const incrementMoney: number = 100;
