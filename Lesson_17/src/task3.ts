...
class Tickler {
  timer: any;
  static countEvent: number = 0;
  static tickler: Tickler | null;
  constructor(
    public seconds: number,
    public message: string,
  ) {
    if (Tickler.tickler) return Tickler.tickler;
...
const eventToDo: string = "pack things for a trip";
