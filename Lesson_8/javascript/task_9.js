 ...
 */
const cellsOfArray = parseInt(prompt("Введіть кількість клітинок масиву", "10"));
const shipsForGame = parseInt(prompt("Введіть кількість кораблів для гри", "5"));
// Створюю поле для гри
function createFieldForGame(cells, ships) {
    let gameArray = [];
...
function gameSeaBattle(fieldGame, ships) {
