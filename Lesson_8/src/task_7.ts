...
function getTotalSum(numbers: number[]): number {
  let sum: number = 0;
...
function getSumInFirstHalfYear(numbers: number[]): number {
  let sum: number = 0;
  for (let i = 0; i <= 5; i++) {
    sum += numbers[i];
  }
...
function getSumInSecondHalfYear(numbers: number[]): number {
  let sum: number = 0;
...
function getSummerSum(numbers: number[]): number {
  let sum: number = 0;
  for (let i = 5; i <= 7; i++) {
    sum += numbers[i];
  }
...
function getSumForSecondQuarter(numbers: number[]): number {
  let sum: number = 0;
  for (let i = 3; i <= 5; i++) {
    sum += numbers[i];
  }
...
function getSumEvenMonth(numbers: number[]): number {
  let sum: number = 0;
...
function getSumFirstMonthsYear(numbers: number[]): number {
  let sum: number = 0;
