...
function competitionResults(array, arrIndex, prizePlace, resArr, currentRes) {
...
resultArr.forEach((competitor, index) => {
    document.write(`<p>Варіант ${index + 1}:<br> 1) ${competitor[0]}, 2) ${competitor[1]}, 3) ${competitor[2]}<br><br></p>`);
});
// for
