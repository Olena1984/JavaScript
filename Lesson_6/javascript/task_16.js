...
do {
    ...
    if (userShotRow === tankRow && userShotCol === tankCol) {
        ...
        alert(`Вітаю ви влучили у танк. Координати: рядокк ${tankRow} стовпець ${tankCol}.\nБроня танка пошкоджена на ${tankHealth} балів`);
        break;
    }
    else if (shells === 0) {
        alert(`Ваші снаряди закінчилися. Танк знаходився у рядку ${tankRow} та стовпці ${tankCol}`);
    }
    else {
    ...
    for (let col = 1; col <= 10; col++) {
        if (row === tankRow && col === tankCol) {
            if (userWin) {
                ...
                document.write(`<p>Вітаю ви влучили у танк. Координати: рядокк ${tankRow} стовпець ${tankCol}.\nБроня танка пошкоджена на ${tankHealth} балів</p> `);
            }
            else {
                document.write(`<td class="col no"></td>`);
                document.write(`<p> Ваші снаряди закінчилися. Танк знаходився у рядку ${tankRow} та стовпці ${tankCol}</p>`);
            }
        }
        else {
...
document.write(`</div>`);
//# sourceMappingURL=task_16.js.map