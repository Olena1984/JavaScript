 ...
 */
alert("Вітаю! Це гра, в якій ви повинні отримати число N. Для цього вам потрібно вибирати пункти меню, які будуть додавати або віднімати числа від вашої суми. Починаємо!\n\n1. Ініціалізація (сума=0)\n2. Додати 2\n3. Додати 3\n4. Відняти 2\n5. Відняти 3\n6. Вивести суму\n7. Вихід");
let finalSum = 0;
