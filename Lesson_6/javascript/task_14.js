...
do {
    ...
    if (userPosRow === null || userPosCol === null) {
        alert(`Ви здаєтеся? Координати корабля: рядок ${rowPosition} * стовпець ${colPosition}`);
        break;
    }
...
if (win) {
    document.write(`<p>Вітаю ви знайшли корабель. Координати: рядок ${rowPosition} * стовпець ${colPosition}.<br> Кількість ваших спроб ${count}</p> `);
}
else {
    document.write(`<p> Не вгадав. Координати: рядок ${rowPosition} * стовпець ${colPosition}</p>`);
}
...
//   }
// } while (true);
//# sourceMappingURL=task_14.js.map