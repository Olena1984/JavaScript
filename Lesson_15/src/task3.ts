...
type AutoType = {
  ...
  refuelingCar(fuelLitres: number): string;
  passengersNumber(): number;
  addPassengers(addPassenger: number): string;
   removePassengers(removePassenger: number):string;
};
const auto: AutoType = {
  brand: "BMW",
  tankSize: 52,
...
const fuelLitres: number = 5;
const addPassenger: number = 1;
const removePassenger: number = 3;
