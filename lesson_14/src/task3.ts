...
// 2)Знайти кількість товарів, у яких ціна зменшилась (price < old_price).
let countProductLessPrice = dataList.reduce(
  (prevCount, price) =>
    price.price < price.old_price ? prevCount + 1 : prevCount,
  0,
);
document.write(
  `<p>Кількість товарів, у яких ціна зменшилась = ${countProductLessPrice}</p>`,
);
...
let newListProduct = productsAvailable.map(
